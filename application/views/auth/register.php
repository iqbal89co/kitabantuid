...
<main class="app-content container center-layout mt-2 mb-2">
	<div class="content-wrapper">
		<link rel="stylesheet" type="text/css" href="https://santara.co.id/assets/css/guest/styles/intlTelInput.min.css">
							...
							<div class="col-md-12 col-xl-12">
										...
										<div class="input-group">
											<div class="iti iti--allow-dropdown iti--separate-dial-code">
												<div class="iti__flag-container">
													<div class="iti__selected-flag" role="combobox" aria-owns="country-listbox" tabindex="0" title="Indonesia: +62">
														<div class="iti__flag iti__id"></div>
														<div class="iti__selected-dial-code">+62</div>
														<div class="iti__arrow"></div>
													</div>
													<ul class="iti__country-list iti__hide" id="country-listbox" aria-expanded="false" role="listbox" aria-activedescendant="iti-item-id">
														<li class="iti__country iti__preferred iti__active" tabindex="-1" id="iti-item-id" role="option" data-dial-code="62" data-country-code="id" aria-selected="true">
								...
								<div class="row mt-1 account-footer">
									<div class="col-12" style="text-align:right">
										Sudah daftar? <a href="<?= base_url() ?>auth">Silakan Login</a>
									</div>
								</div>
							</div>
						</div>
		...
		<script src="<?= base_url('assets/') ?>assets/js/scripts/intl-tel-input/intlTelInput.min.js"></script>
		<script src="<?= base_url('assets/') ?>assets/js/guest/register.js?v=5.8.0"></script>
	</div>
</main>
<link rel="stylesheet" href="https://chat.sociomile.com/css/app.css?id=ZJcr9BYwHRirN7ypP9xeZpuA" media="all">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css" media="all">
<link rel="stylesheet" href="https://smcdn.s45.in/2020/10/14//tmp/chat_5f5073d5801ddf564e5885b1.css?id=5f86e1111ca38" media="all">
